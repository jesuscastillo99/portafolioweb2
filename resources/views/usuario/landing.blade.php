          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbarLight" aria-labelledby="offcanvasNavbarLightLabel">
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-center flex-grow-1 pe-1">
                ...
                <li class="nav-item">
                    <a class="nav-link mx-lg-2 {{ Route::currentRouteName() == 'cobranza' ? 'active' : '' }}" href="{{ route('cobranza') }}">Sobre mí</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link mx-lg-2 {{ Route::currentRouteName() == 'cartera' ? 'active' : '' }}" href="{{ route('cartera') }}">Portafolio</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link mx-lg-2 {{ Route::currentRouteName() == 'pagos' ? 'active' : '' }}" href="{{ route('pagos') }}">Educación</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link mx-lg-2 {{ Route::currentRouteName() == 'contratos' ? 'active' : '' }}" href="{{ route('contratos') }}">Habilidades</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link mx-lg-2 {{ Route::currentRouteName() == 'seguimiento' ? 'active' : '' }}" href="{{ route('seguimiento') }}">Contacto</a>
                </li>
