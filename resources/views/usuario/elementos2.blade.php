...
@section('title', 'Elementos Usuario')
@section('content')
<!-- section -->
            ...
            <div class="col-md-4">
                <div class="card mb-4 {{ $ele->isGreen ? 'bg-success text-white' : '' }}">
                    <div class="card-body">
                        ...
                        <a href="{{ route('evidenciasu', ['iddireccion' => $iddireccion, 'idtrimestre' => $idtrimestre, 'idelemento' => $ele->idelemento]) }}" class="btn btn-primary">Ver Evidencias</a>
                    </div>
                </div>
            </div>
            @endforeach
